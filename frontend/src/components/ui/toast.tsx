...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-error-100 group-[.destructive]:hover:border-error-100 group-[.destructive]:hover:bg-error-100 group-[.destructive]:hover:text-error-900 group-[.destructive]:focus:ring-error-400",
 className
 )}
 {...props} />
))
